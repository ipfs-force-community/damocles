...
pub(crate) fn seal_types_from_u64(u: u64) -> Result<Vec<SealProof>, Error> {
    match u {
        SIZE_2K => Ok(vec![SealProof::StackedDrg2KiBV1_1]),
        SIZE_8M => Ok(vec![SealProof::StackedDrg8MiBV1_1]),
        SIZE_512M => Ok(vec![SealProof::StackedDrg512MiBV1_1]),
        SIZE_32G => Ok(vec![SealProof::StackedDrg32GiBV1_1]),
        SIZE_64G => Ok(vec![SealProof::StackedDrg64GiBV1_1]),
