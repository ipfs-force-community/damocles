...
use crate::fil_proofs::{Commitment, PaddedBytesAmount, PieceInfo, UnpaddedBytesAmount};
...
pub fn add_piece_for_cc_sector(staged_file: &fs::File, sector_size: u64) -> Result<PieceInfo> {
    ...
    let commitment = get_all_zero_commitment(sector_size).context("get zero commitment")?;
