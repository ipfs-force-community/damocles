...
func serveSealerAPI(ctx context.Context, stopper dix.StopFunc, node core.SealerAPI, addr string, plugins *managerplugin.LoadedPlugins) error {
...
func buildRPCServer(hdl interface{}, plugins *managerplugin.LoadedPlugins, opts ...jsonrpc.ServerOption) (*http.ServeMux, error) {
	// use field
	...
	if plugins != nil {
		_ = plugins.Foreach(managerplugin.RegisterJsonRpc, func(plugin *managerplugin.Plugin) error {
