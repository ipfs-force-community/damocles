...
var utilMigrateCmd = &cli.Command{
	Name:  "migrate",
	Usage: "Migrating damocles-manager's database data",
	Flags: []cli.Flag{
		HomeFlag,
		&cli.StringFlag{
			Name:        "from",
	...
	Action: func(cctx *cli.Context) error {
		...
		loadedPlugins := new(*managerplugin.LoadedPlugins)
...
func Dep(cctx *cli.Context, wants ...any) (stop func(), err error) {
	...
	stopper, err = dix.New(
		...
		dix.Options(
			...
			dix.Override(new(*managerplugin.LoadedPlugins), dep.ProvidePlugins),
