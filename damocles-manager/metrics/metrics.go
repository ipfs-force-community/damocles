...
var (
	// common
	DamoclesInfo = stats.Int64("info", "Arbitrary counter to tag damocles info", stats.UnitDimensionless)

	DamoclesManagerNewSector = stats.Int64("damocles_manager/new_sector", "Count the new sector", stats.UnitDimensionless)

	DamoclesManagerPreCommitSector = stats.Int64("damocles_manager/pre_commit_sector", "Count the pre commit sector", stats.UnitDimensionless)

	DamoclesManagerCommitSector = stats.Int64("damocles_manager/commit_sector", "Count the commit sector", stats.UnitDimensionless)
...
var (
	InfoView = &view.View{
		Name:        "info",
		Description: "damocles information",
		Measure:     DamoclesInfo,
	...
	NewSectorView = &view.View{
		Name:        "new_sector",
		Description: "count of damocles manager new sector",
		TagKeys:     []tag.Key{Miner},
		Measure:     DamoclesManagerNewSector,
		Aggregation: view.Count(),
	}

	SectorPreCommitView = &view.View{
		Name:        "sector_pre_commit",
		Description: "count of damocles manager pre commit sector",
		TagKeys:     []tag.Key{Miner},
		Measure:     DamoclesManagerPreCommitSector,
		Aggregation: view.Count(),
	}

	SectorCommitView = &view.View{
		Name:        "sector_commit",
		Description: "count of damocles manager commit sector",
		TagKeys:     []tag.Key{Miner},
		Measure:     DamoclesManagerCommitSector,
		Aggregation: view.Count(),
	}
