# Support for SnapDeal

## Brief Overview of SnapDeal
...
Therefore, SnapDeal is attractive for both new real data storage requirements and the conversion of existing `CC sectors`.
