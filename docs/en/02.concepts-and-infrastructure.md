...
This module manages deals. It is mainly responsible for assigning order `pieces` that can fit into empty allocated sectors, as well as releasing deals in failed sectors.
