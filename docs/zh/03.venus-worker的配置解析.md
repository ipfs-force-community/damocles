...
#### 参考案例
[参考案例 1](https://github.com/cloudxin/venus-cluster/docs/example/Example-1.md)
特点: PC1精确限核，C2采用gpuproxy方式完成，具有很强的可扩展性。缺点是配置复杂，需要根据实际环境调整任务数

[参考案例 2](https://github.com/cloudxin/venus-cluster/docs/example/Example-2.md)
特点: PC2和C2共享1个GPU，可能会产生一些C2任务将积压

[参考案例 3](https://github.com/cloudxin/venus-cluster/docs/example/Example-3.md)
特点: 2组PC2与分别与2组C2共享GPU资源

[参考案例 4](https://github.com/cloudxin/venus-cluster/docs/example/Example-4.md)
特点: 适用于低配置机器使用，在NVMe上创建96G的swap空间，但这可能会导致某些任务做得比较慢
