...
在有些场景下很不方便，例如: [扇区重建](https://github.com/ipfs-force-community/venus-cluster/blob/merge/0x5459/reabse_main_into_rebuild_branch/docs/zh/16.%E6%89%87%E5%8C%BA%E9%87%8D%E5%BB%BA%E7%9A%84%E6%94%AF%E6%8C%81.md)时我们希望能够在不重启 venus-worker 的情况下修改指定的 `sealing_thread` 的 `plan` 配置项。
